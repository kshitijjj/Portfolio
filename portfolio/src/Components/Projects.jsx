...
<div className='pro' id="projects" style={{marginLeft:"2pxō"}} >
            ...
            <div data-aos='fade-up' className="pro2">
                ...
                <ProjectCard id="project_card_text3"  title="Locale" desc="Locale is your one stop destination to exploring and experiencing The City Beautiful-Chandigarh🌱" github="https://github.com/kshitijjj/LOCALE.git"   />
